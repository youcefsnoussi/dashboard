...
public class history_article_selled {
	...
	public String history_vente_quantite(HttpServletRequest request,
		...
		if(date_debut.equals("0") && date_fin.equals("0")) {
			...
			list = fact_detRepo.get_quantite_sold(gtd.get_date(), gtd.get_date());
			...
			list =  fact_detRepo.get_quantite_sold(conv.convertion_InputDate_to_MyDate(date_debut), conv.convertion_InputDate_to_MyDate(date_fin));
	...
	public String history_vente_quantite_val(HttpServletRequest request,
		...
		if(date_debut.equals("0") && date_fin.equals("0")) {
			...
			list = fact_detRepo.get_quantite_sold_val(gtd.get_date(), gtd.get_date());
			...
			list =  fact_detRepo.get_quantite_sold_val(conv.convertion_InputDate_to_MyDate(date_debut), conv.convertion_InputDate_to_MyDate(date_fin));
